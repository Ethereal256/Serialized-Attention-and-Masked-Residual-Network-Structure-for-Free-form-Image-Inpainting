...
class Dataset(torch.utils.data.Dataset):
    ...
    def load_item(self, index):
        ...
        return self.to_tensor(img), self.to_tensor(mask), index, name
    ...
    def load_mask(self, img, index):
        ...
        if self.training:
            ...
            mask = imageio.imread(self.mask_data[(index%2000)])
            #mask = imread(self.mask_data[(index%2000)])   # mask must be 255 for hole in this InpaintingModel
